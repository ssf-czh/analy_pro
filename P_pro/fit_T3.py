...
def func_T3(T,D0,D1,D2,D3):
    ...
    '''
    T4,TS,H,G = T
    T3 = D0*TS+D1*T4+D2*np.power((H/G),D3)
    return T3
...
def calc_pre(T3,W):
    ...
    :return:
    '''
    predict_T3 = func_T3(W,-2.39540821e-10,  1.00000000e+00, -4.99999944e+00,  1.77612078e-08)
...
if __name__ == '__main__':
    ...
    #
    a, b = curve_fit(func_T3, (T4, TS, H, G), T3)
    print(a)
    print("==="*20)
    print(b)
    avg_err, rmse = calc_pre(T3,(T4, TS, H, G))
    print(avg_err)
    print(rmse)

    for i in range(len(T3)):
        print("真实值：{:s},预测值{:s}".format(str(T3[i]),str(func_T3((T4[i], TS[i], H[i], G[i]),-2.39540821e-10 , 1.00000000e+00, -4.99999944e+00,  1.77612078e-08))))