...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.wet_bulb_fittings.setLineWidth(70)
        self.wet_bulb_fittings.setColumnWidth(0, 150)
        ...
        self.B3_11 = QtWidgets.QPushButton(self.page_3)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.B3_11.setFont(font)
        self.B3_11.setObjectName("B3_11")
        self.horizontalLayout_6.addWidget(self.B3_11)
        self.B3_12 = QtWidgets.QPushButton(self.page_3)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.B3_12.setFont(font)
        self.B3_12.setObjectName("B3_22")
        self.horizontalLayout_6.addWidget(self.B3_12)
        self.B3_13 = QtWidgets.QPushButton(self.page_3)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.B3_13.setFont(font)
        self.B3_13.setObjectName("B3_13")
        self.horizontalLayout_6.addWidget(self.B3_13)


        self.B3_14 = QtWidgets.QPushButton(self.page_3)
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.B3_14.clicked.connect(self.wet_bulb_fittings.clearContents)
        self.B3_14.clicked.connect(self.main_fittings.clearContents)
        self.B3_14.clicked.connect(self.pump3_fittings.clearContents)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.clicked.connect(click_cancel1)
        # 绑定读入事件
        self.B2_1.clicked.connect(click_load2)
        self.B2_2.clicked.connect(click_load2)
        self.B2_3.clicked.connect(click_load2)
        self.B2_4.clicked.connect(click_load2)
        self.B2_5.clicked.connect(click_load2)
