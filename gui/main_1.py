...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        item = self.main_fittings.item(0, 1)
        item.setText(_translate("MainWindow", "Q"))
        item = self.main_fittings.item(0, 2)
        item.setText(_translate("MainWindow", "P1"))
        item = self.main_fittings.item(0, 3)
        item.setText(_translate("MainWindow", "T1"))
        item = self.main_fittings.item(0, 4)
        item.setText(_translate("MainWindow", "T2"))
        item = self.main_fittings.item(0, 5)
        item.setText(_translate("MainWindow", "T3"))
        item = self.main_fittings.item(0, 6)
        item.setText(_translate("MainWindow", "T4"))
        item = self.main_fittings.item(0, 7)
        ...
        item.setText(_translate("MainWindow", "℃"))
        item = self.main_fittings.item(2, 0)
        item.setText(_translate("MainWindow", "100.0"))
        item = self.main_fittings.item(2, 1)
        item.setText(_translate("MainWindow", "2813.0"))
        item = self.main_fittings.item(2, 2)
        item.setText(_translate("MainWindow", "541.0"))
        item = self.main_fittings.item(2, 3)
        item.setText(_translate("MainWindow", "6.0"))
        item = self.main_fittings.item(2, 4)
        item.setText(_translate("MainWindow", "10.0"))
        item = self.main_fittings.item(2, 5)
        item.setText(_translate("MainWindow", "34.0"))
        item = self.main_fittings.item(2, 6)
        item.setText(_translate("MainWindow", "38.0"))
        item = self.main_fittings.item(2, 7)
        item.setText(_translate("MainWindow", "5.198"))
        item = self.main_fittings.item(3, 0)
        item.setText(_translate("MainWindow", "90.0"))
        item = self.main_fittings.item(3, 1)
        item.setText(_translate("MainWindow", "2532.0"))
        item = self.main_fittings.item(3, 2)
        item.setText(_translate("MainWindow", "483.4"))
        item = self.main_fittings.item(3, 3)
        item.setText(_translate("MainWindow", "6.0"))
        item = self.main_fittings.item(3, 4)
        item.setText(_translate("MainWindow", "9.6"))
        ...
        item.setText(_translate("MainWindow", "5.238"))
        ...
        item.setText(_translate("MainWindow", "冷冻水泵设备P2:"))
        ...
        item = self.pump2_fittings.item(1, 4)
        item.setText(_translate("MainWindow", "G2"))
        item = self.pump2_fittings.item(1, 5)
        item.setText(_translate("MainWindow", "P2"))
        item = self.pump2_fittings.item(1, 6)
        item.setText(_translate("MainWindow", "G2"))
        item = self.pump2_fittings.item(1, 7)
        item.setText(_translate("MainWindow", "P2"))
        item = self.pump2_fittings.item(1, 8)
        item.setText(_translate("MainWindow", "G2"))
        item = self.pump2_fittings.item(1, 9)
        item.setText(_translate("MainWindow", "P2"))
        item = self.pump2_fittings.item(1, 10)
        item.setText(_translate("MainWindow", "G2"))
        item = self.pump2_fittings.item(1, 11)
        item.setText(_translate("MainWindow", "P2"))
        ...
        item = self.pump2_fittings.item(2, 4)
        item.setText(_translate("MainWindow", "流量（m3/h)"))
        item = self.pump2_fittings.item(2, 5)
        item.setText(_translate("MainWindow", "轴功率(kw)"))
        item = self.pump2_fittings.item(2, 6)
        item.setText(_translate("MainWindow", "流量（m3/h)"))
        item = self.pump2_fittings.item(2, 7)
        item.setText(_translate("MainWindow", "轴功率(kw)"))
        item = self.pump2_fittings.item(2, 8)
        item.setText(_translate("MainWindow", "流量（m3/h)"))
        item = self.pump2_fittings.item(2, 9)
        item.setText(_translate("MainWindow", "轴功率(kw)"))
        item = self.pump2_fittings.item(2, 10)
        item.setText(_translate("MainWindow", "流量（m3/h)"))
        item = self.pump2_fittings.item(2, 11)
        item.setText(_translate("MainWindow", "轴功率(kw)"))
        item = self.pump2_fittings.item(3, 0)
        item.setText(_translate("MainWindow", "1"))
        item = self.pump2_fittings.item(3, 1)
        item.setText(_translate("MainWindow", "冷冻泵 250KQW500-44-90/4"))
        item = self.pump2_fittings.item(3, 2)
        item.setText(_translate("MainWindow", "533"))
        item = self.pump2_fittings.item(3, 3)
        item.setText(_translate("MainWindow", "78"))
        item = self.pump2_fittings.item(3, 4)
        item.setText(_translate("MainWindow", "498"))
        item = self.pump2_fittings.item(3, 5)
        item.setText(_translate("MainWindow", "56.8"))
        item = self.pump2_fittings.item(3, 6)
        item.setText(_translate("MainWindow", "442"))
        item = self.pump2_fittings.item(3, 7)
        item.setText(_translate("MainWindow", "39.9"))
        item = self.pump2_fittings.item(3, 8)
        item.setText(_translate("MainWindow", "387"))
        item = self.pump2_fittings.item(3, 9)
        item.setText(_translate("MainWindow", "26.8"))
        item = self.pump2_fittings.item(3, 10)
        item.setText(_translate("MainWindow", "331"))
        item = self.pump2_fittings.item(3, 11)
        item.setText(_translate("MainWindow", "16.8"))
        item = self.pump2_fittings.item(4, 0)
        item.setText(_translate("MainWindow", "P2=A0+A1*G2+A2*G2*G2。\n"
"已知参数：P2，G2；拟合参数：A0---A2。"))
        ...
        item.setText(_translate("MainWindow", "冷却水泵设备P3:"))
        ...
        item = self.pump3_fittings.item(1, 4)
        item.setText(_translate("MainWindow", "G3"))
        item = self.pump3_fittings.item(1, 5)
        item.setText(_translate("MainWindow", "P3"))
        item = self.pump3_fittings.item(1, 6)
        item.setText(_translate("MainWindow", "G3"))
        item = self.pump3_fittings.item(1, 7)
        item.setText(_translate("MainWindow", "P3"))
        item = self.pump3_fittings.item(1, 8)
        item.setText(_translate("MainWindow", "G3"))
        item = self.pump3_fittings.item(1, 9)
        item.setText(_translate("MainWindow", "P3"))
        item = self.pump3_fittings.item(1, 10)
        item.setText(_translate("MainWindow", "G3"))
        item = self.pump3_fittings.item(1, 11)
        item.setText(_translate("MainWindow", "P3"))
        item = self.pump3_fittings.item(2, 2)
        item.setText(_translate("MainWindow", "流量（m3/h)"))
        item = self.pump3_fittings.item(2, 3)
        item.setText(_translate("MainWindow", "轴功率(kw)"))
        item = self.pump3_fittings.item(2, 4)
        item.setText(_translate("MainWindow", "流量（m3/h)"))
        item = self.pump3_fittings.item(2, 5)
        item.setText(_translate("MainWindow", "轴功率(kw)"))
        item = self.pump3_fittings.item(2, 6)
        item.setText(_translate("MainWindow", "流量（m3/h)"))
        item = self.pump3_fittings.item(2, 7)
        item.setText(_translate("MainWindow", "轴功率(kw)"))
        item = self.pump3_fittings.item(2, 8)
        item.setText(_translate("MainWindow", "流量（m3/h)"))
        item = self.pump3_fittings.item(2, 9)
        item.setText(_translate("MainWindow", "轴功率(kw)"))
        item = self.pump3_fittings.item(2, 10)
        item.setText(_translate("MainWindow", "流量（m3/h)"))
        item = self.pump3_fittings.item(2, 11)
        item.setText(_translate("MainWindow", "轴功率(kw)"))
        item = self.pump3_fittings.item(3, 0)
        item.setText(_translate("MainWindow", "1"))
        item = self.pump3_fittings.item(3, 1)
...
"已知参数：P3，G3；拟合参数：C0---C2。"))
        ...
        item.setText(_translate("MainWindow", "T∆ 冷幅与湿球温度的拟合,P0=22Kw。"))
        item = self.wet_bulb_fittings.item(0, 3)
        item.setText(_translate("MainWindow", "P4功率与流量的拟合"))
