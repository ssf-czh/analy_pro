...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_11y = QtWidgets.QLabel(self.page_10)
        self.label_11y.setObjectName("label_11y")
        self.horizontalLayout_01.addWidget(self.label_11y)
        self.label_22m = QtWidgets.QLabel(self.page_10)
        self.label_22m.setObjectName("label_22m")
        self.horizontalLayout_01.addWidget(self.label_22m)
        self.label_33d = QtWidgets.QLabel(self.page_10)
        self.label_33d.setObjectName("label_33d")
        self.horizontalLayout_01.addWidget(self.label_33d)
        self.label_44h = QtWidgets.QLabel(self.page_10)
        self.label_44h.setObjectName("label_44h")
        self.horizontalLayout_01.addWidget(self.label_44h)
        ...
        self.listWidget_y = QtWidgets.QListWidget(self.page_10)
        self.listWidget_y.setObjectName("listWidget_y")
        item = QtWidgets.QListWidgetItem()
        self.listWidget_y.addItem(item)
        item = QtWidgets.QListWidgetItem()
        self.listWidget_y.addItem(item)
        item = QtWidgets.QListWidgetItem()
        self.listWidget_y.addItem(item)
        ...
        item = QtWidgets.QListWidgetItem()
        self.listWidget_y.addItem(item)
        self.horizontalLayout_02.addWidget(self.listWidget_y)
        self.listWidget_m = QtWidgets.QListWidget(self.page_10)
        self.listWidget_m.setObjectName("listWidget_m")
        item = QtWidgets.QListWidgetItem()
        self.listWidget_m.addItem(item)
        item = QtWidgets.QListWidgetItem()
        self.listWidget_m.addItem(item)
        item = QtWidgets.QListWidgetItem()
        self.listWidget_m.addItem(item)
        ...
        item = QtWidgets.QListWidgetItem()
        self.listWidget_m.addItem(item)
        self.horizontalLayout_02.addWidget(self.listWidget_m)
        self.listWidget_d = QtWidgets.QListWidget(self.page_10)
        self.listWidget_d.setObjectName("listWidget_d")
        item = QtWidgets.QListWidgetItem()
        self.listWidget_d.addItem(item)
        item = QtWidgets.QListWidgetItem()
        self.listWidget_d.addItem(item)
        item = QtWidgets.QListWidgetItem()
        self.listWidget_d.addItem(item)
        ...
        item = QtWidgets.QListWidgetItem()
        self.listWidget_d.addItem(item)
        self.horizontalLayout_02.addWidget(self.listWidget_d)
        self.listWidget_h = QtWidgets.QListWidget(self.page_10)
        self.listWidget_h.setObjectName("listWidget_h")
        item = QtWidgets.QListWidgetItem()
        self.listWidget_h.addItem(item)
        item = QtWidgets.QListWidgetItem()
        self.listWidget_h.addItem(item)
        item = QtWidgets.QListWidgetItem()
        self.listWidget_h.addItem(item)
        ...
        item = QtWidgets.QListWidgetItem()
        self.listWidget_h.addItem(item)
        self.horizontalLayout_02.addWidget(self.listWidget_h)
        self.verticalLayout_01.addLayout(self.horizontalLayout_02)
        self.verticalLayout_1114.addLayout(self.verticalLayout_01)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.tableWidget_56.setItem(0, 0, item)
        item = self.tableWidget_56.item(0, 0)
        item.setText(_translate("MainWindow", "年"))

        item = QtWidgets.QTableWidgetItem()
        self.tableWidget_56.setItem(0, 1, item)
        item = self.tableWidget_56.item(0, 1)
        item.setText(_translate("MainWindow", "月"))

        item = QtWidgets.QTableWidgetItem()
        self.tableWidget_56.setItem(0, 2, item)
        item = self.tableWidget_56.item(0, 2)
        item.setText(_translate("MainWindow", "日"))

        item = QtWidgets.QTableWidgetItem()
        self.tableWidget_56.setItem(0, 3, item)
        item = self.tableWidget_56.item(0, 3)
        item.setText(_translate("MainWindow", "时"))

        item = QtWidgets.QTableWidgetItem()
        self.tableWidget_56.setItem(0, 4, item)
        item = self.tableWidget_56.item(0, 4)
        item.setText(_translate("MainWindow", "负荷Q/Kw"))

        item = QtWidgets.QTableWidgetItem()
        self.tableWidget_56.setItem(0, 5, item)
        item = self.tableWidget_56.item(0, 5)
        item.setText(_translate("MainWindow", "湿球温度Ts/℃"))

        item = QtWidgets.QTableWidgetItem()
        self.tableWidget_56.setItem(0, 6, item)
        item = self.tableWidget_56.item(0, 6)
        item.setText(_translate("MainWindow", "干球温度T/℃"))

        item = QtWidgets.QTableWidgetItem()
        self.tableWidget_56.setItem(0, 7, item)
        item = self.tableWidget_56.item(0, 7)
        item.setText(_translate("MainWindow", "单机负荷百分比/%"))

        item = QtWidgets.QTableWidgetItem()
        self.tableWidget_56.setItem(0, 8, item)
        item = self.tableWidget_56.item(0, 8)
        item.setText(_translate("MainWindow", "系统负荷百分比/%"))

        item = QtWidgets.QTableWidgetItem()
        self.tableWidget_56.setItem(0, 9, item)
        item = self.tableWidget_56.item(0, 9)
        item.setText(_translate("MainWindow", "主机cop"))

        item = QtWidgets.QTableWidgetItem()
        self.tableWidget_56.setItem(0, 10, item)
        item = self.tableWidget_56.item(0, 10)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_11y.setText(_translate("MainWindow", "年"))
        self.label_22m.setText(_translate("MainWindow", "月"))
        self.label_33d.setText(_translate("MainWindow", "日"))
        self.label_44h.setText(_translate("MainWindow", "时"))
        __sortingEnabled = self.listWidget_y.isSortingEnabled()
        self.listWidget_y.setSortingEnabled(False)
        item = self.listWidget_y.item(0)
        item.setText(_translate("MainWindow", "2019"))
        item = self.listWidget_y.item(1)
        item.setText(_translate("MainWindow", "2020"))
        item = self.listWidget_y.item(2)
        item.setText(_translate("MainWindow", "2021"))
        item = self.listWidget_y.item(3)
        item.setText(_translate("MainWindow", "2022"))
        item = self.listWidget_y.item(4)
        item.setText(_translate("MainWindow", "2023"))
        item = self.listWidget_y.item(5)
        item.setText(_translate("MainWindow", "2024"))
        item = self.listWidget_y.item(6)
        item.setText(_translate("MainWindow", "2025"))
        item = self.listWidget_y.item(7)
        item.setText(_translate("MainWindow", "2026"))
        item = self.listWidget_y.item(8)
        item.setText(_translate("MainWindow", "2027"))
        item = self.listWidget_y.item(9)
        item.setText(_translate("MainWindow", "2028"))
        item = self.listWidget_y.item(10)
        item.setText(_translate("MainWindow", "2029"))
        item = self.listWidget_y.item(11)
        item.setText(_translate("MainWindow", "2030"))
        item = self.listWidget_y.item(12)
        item.setText(_translate("MainWindow", "2031"))
        item = self.listWidget_y.item(13)
        item.setText(_translate("MainWindow", "2032"))
        item = self.listWidget_y.item(14)
        item.setText(_translate("MainWindow", "2033"))
        item = self.listWidget_y.item(15)
        item.setText(_translate("MainWindow", "2034"))
        item = self.listWidget_y.item(16)
        item.setText(_translate("MainWindow", "2035"))
        item = self.listWidget_y.item(17)
        item.setText(_translate("MainWindow", "2036"))
        item = self.listWidget_y.item(18)
        item.setText(_translate("MainWindow", "2037"))
        item = self.listWidget_y.item(19)
        item.setText(_translate("MainWindow", "2038"))
        item = self.listWidget_y.item(20)
        item.setText(_translate("MainWindow", "2039"))
        item = self.listWidget_y.item(21)
        item.setText(_translate("MainWindow", "2040"))
        item = self.listWidget_y.item(22)
        item.setText(_translate("MainWindow", "2041"))
        item = self.listWidget_y.item(23)
        item.setText(_translate("MainWindow", "2042"))
        item = self.listWidget_y.item(24)
        item.setText(_translate("MainWindow", "2043"))
        item = self.listWidget_y.item(25)
        item.setText(_translate("MainWindow", "2044"))
        item = self.listWidget_y.item(26)
        item.setText(_translate("MainWindow", "2045"))
        item = self.listWidget_y.item(27)
        item.setText(_translate("MainWindow", "2046"))
        item = self.listWidget_y.item(28)
        item.setText(_translate("MainWindow", "2047"))
        item = self.listWidget_y.item(29)
        item.setText(_translate("MainWindow", "2048"))
        item = self.listWidget_y.item(30)
        item.setText(_translate("MainWindow", "2049"))
        item = self.listWidget_y.item(31)
        item.setText(_translate("MainWindow", "2050"))
        self.listWidget_y.setSortingEnabled(__sortingEnabled)
        __sortingEnabled = self.listWidget_m.isSortingEnabled()
        self.listWidget_m.setSortingEnabled(False)
        item = self.listWidget_m.item(0)
        item.setText(_translate("MainWindow", "1"))
        item = self.listWidget_m.item(1)
        item.setText(_translate("MainWindow", "2"))
        item = self.listWidget_m.item(2)
        item.setText(_translate("MainWindow", "3"))
        item = self.listWidget_m.item(3)
        item.setText(_translate("MainWindow", "4"))
        item = self.listWidget_m.item(4)
        item.setText(_translate("MainWindow", "5"))
        item = self.listWidget_m.item(5)
        item.setText(_translate("MainWindow", "6"))
        item = self.listWidget_m.item(6)
        item.setText(_translate("MainWindow", "7"))
        item = self.listWidget_m.item(7)
        item.setText(_translate("MainWindow", "8"))
        item = self.listWidget_m.item(8)
        item.setText(_translate("MainWindow", "9"))
        item = self.listWidget_m.item(9)
        item.setText(_translate("MainWindow", "10"))
        item = self.listWidget_m.item(10)
        item.setText(_translate("MainWindow", "11"))
        item = self.listWidget_m.item(11)
        item.setText(_translate("MainWindow", "12"))
        self.listWidget_m.setSortingEnabled(__sortingEnabled)
        __sortingEnabled = self.listWidget_d.isSortingEnabled()
        self.listWidget_d.setSortingEnabled(False)
        item = self.listWidget_d.item(0)
        item.setText(_translate("MainWindow", "1"))
        item = self.listWidget_d.item(1)
        item.setText(_translate("MainWindow", "2"))
        item = self.listWidget_d.item(2)
        item.setText(_translate("MainWindow", "3"))
        item = self.listWidget_d.item(3)
        item.setText(_translate("MainWindow", "4"))
        item = self.listWidget_d.item(4)
        item.setText(_translate("MainWindow", "5"))
        item = self.listWidget_d.item(5)
        item.setText(_translate("MainWindow", "6"))
        item = self.listWidget_d.item(6)
        item.setText(_translate("MainWindow", "7"))
        item = self.listWidget_d.item(7)
        item.setText(_translate("MainWindow", "8"))
        item = self.listWidget_d.item(8)
        item.setText(_translate("MainWindow", "9"))
        item = self.listWidget_d.item(9)
        item.setText(_translate("MainWindow", "10"))
        item = self.listWidget_d.item(10)
        item.setText(_translate("MainWindow", "11"))
        item = self.listWidget_d.item(11)
        item.setText(_translate("MainWindow", "12"))
        item = self.listWidget_d.item(12)
        item.setText(_translate("MainWindow", "13"))
        item = self.listWidget_d.item(13)
        item.setText(_translate("MainWindow", "14"))
        item = self.listWidget_d.item(14)
        item.setText(_translate("MainWindow", "15"))
        item = self.listWidget_d.item(15)
        item.setText(_translate("MainWindow", "16"))
        item = self.listWidget_d.item(16)
        item.setText(_translate("MainWindow", "17"))
        item = self.listWidget_d.item(17)
        item.setText(_translate("MainWindow", "18"))
        item = self.listWidget_d.item(18)
        item.setText(_translate("MainWindow", "19"))
        item = self.listWidget_d.item(19)
        item.setText(_translate("MainWindow", "20"))
        item = self.listWidget_d.item(20)
        item.setText(_translate("MainWindow", "21"))
        item = self.listWidget_d.item(21)
        item.setText(_translate("MainWindow", "22"))
        item = self.listWidget_d.item(22)
        item.setText(_translate("MainWindow", "23"))
        item = self.listWidget_d.item(23)
        item.setText(_translate("MainWindow", "24"))
        item = self.listWidget_d.item(24)
        item.setText(_translate("MainWindow", "25"))
        item = self.listWidget_d.item(25)
        item.setText(_translate("MainWindow", "26"))
        item = self.listWidget_d.item(26)
        item.setText(_translate("MainWindow", "27"))
        item = self.listWidget_d.item(27)
        item.setText(_translate("MainWindow", "28"))
        item = self.listWidget_d.item(28)
        item.setText(_translate("MainWindow", "29"))
        item = self.listWidget_d.item(29)
        item.setText(_translate("MainWindow", "30"))
        item = self.listWidget_d.item(30)
        item.setText(_translate("MainWindow", "31"))
        self.listWidget_d.setSortingEnabled(__sortingEnabled)
        __sortingEnabled = self.listWidget_h.isSortingEnabled()
        self.listWidget_h.setSortingEnabled(False)
        item = self.listWidget_h.item(0)
        item.setText(_translate("MainWindow", "0"))
        item = self.listWidget_h.item(1)
        item.setText(_translate("MainWindow", "1"))
        item = self.listWidget_h.item(2)
        item.setText(_translate("MainWindow", "2"))
        item = self.listWidget_h.item(3)
        item.setText(_translate("MainWindow", "3"))
        item = self.listWidget_h.item(4)
        item.setText(_translate("MainWindow", "4"))
        item = self.listWidget_h.item(5)
        item.setText(_translate("MainWindow", "5"))
        item = self.listWidget_h.item(6)
        item.setText(_translate("MainWindow", "6"))
        item = self.listWidget_h.item(7)
        item.setText(_translate("MainWindow", "7"))
        item = self.listWidget_h.item(8)
        item.setText(_translate("MainWindow", "8"))
        item = self.listWidget_h.item(9)
        item.setText(_translate("MainWindow", "9"))
        item = self.listWidget_h.item(10)
        item.setText(_translate("MainWindow", "10"))
        item = self.listWidget_h.item(11)
        item.setText(_translate("MainWindow", "11"))
        item = self.listWidget_h.item(12)
        item.setText(_translate("MainWindow", "12"))
        item = self.listWidget_h.item(13)
        item.setText(_translate("MainWindow", "13"))
        item = self.listWidget_h.item(14)
        item.setText(_translate("MainWindow", "14"))
        item = self.listWidget_h.item(15)
        item.setText(_translate("MainWindow", "15"))
        item = self.listWidget_h.item(16)
        item.setText(_translate("MainWindow", "16"))
        item = self.listWidget_h.item(17)
        item.setText(_translate("MainWindow", "17"))
        item = self.listWidget_h.item(18)
        item.setText(_translate("MainWindow", "18"))
        item = self.listWidget_h.item(19)
        item.setText(_translate("MainWindow", "19"))
        item = self.listWidget_h.item(20)
        item.setText(_translate("MainWindow", "20"))
        item = self.listWidget_h.item(21)
        item.setText(_translate("MainWindow", "21"))
        item = self.listWidget_h.item(22)
        item.setText(_translate("MainWindow", "22"))
        item = self.listWidget_h.item(23)
        item.setText(_translate("MainWindow", "23"))
        self.listWidget_h.setSortingEnabled(__sortingEnabled)
        ...
        self.pump_cop_status = False
        self.system_cop_status = False


        def cop_Checkbox():

            status = self.checkBox_63.isChecked()
            if status is True:
        ...
        self.checkBox_63.stateChanged.connect(cop_Checkbox)

        def pump_cop_Checkbox():
            if self.checkBox_64.isChecked():
                self.pump_cop_status = True
            else:
                self.pump_cop_status = False
            print("pumping_cop:", self.pump_cop_status)

        self.checkBox_64.stateChanged.connect(pump_cop_Checkbox)

        def system_cop_Checkbox():
            if self.checkBox_65.isChecked():
                self.system_cop_status = True
            else:
                self.system_cop_status = False
            print("system_cop_status:", self.system_cop_status)

        self.checkBox_65.stateChanged.connect(system_cop_Checkbox)
        ...
        def show_cop():
            ...
            for index, res in enumerate(model.db.optimize_result):
                ...
                if year >= y1 and year <= y2 and month >= m1 and month <= m2 and day >= d1 and day <= d2 and hour >= h1 and hour <= h2:
                    fit_res_index.append(index)
                    self.table_56_records.append(res)
            global table_56_records
            table_56_records = self.table_56_records
            self.table_56_count = len(fit_res_index)
            self.tableWidget_56.setRowCount(len(fit_res_index) + 1)
            self.tableWidget_56.setColumnCount(16)
            ...
            for index in fit_res_index:
                ...
                item = QtWidgets.QTableWidgetItem()
                self.tableWidget_56.setItem(count, 0, item)
                item = self.tableWidget_56.item(count, 0)
                item.setText(_translate("MainWindow", str(int(year))))

                item = QtWidgets.QTableWidgetItem()
                self.tableWidget_56.setItem(count, 1, item)
                item = self.tableWidget_56.item(count, 1)
                item.setText(_translate("MainWindow", str(int(month))))

                item = QtWidgets.QTableWidgetItem()
                self.tableWidget_56.setItem(count, 2, item)
                item = self.tableWidget_56.item(count, 2)
                item.setText(_translate("MainWindow", str(int(day))))

                item = QtWidgets.QTableWidgetItem()
                self.tableWidget_56.setItem(count, 3, item)
                item = self.tableWidget_56.item(count, 3)
                item.setText(_translate("MainWindow", str(int(hour))))

                item = QtWidgets.QTableWidgetItem()
                self.tableWidget_56.setItem(count, 4, item)
                item = self.tableWidget_56.item(count, 4)
                item.setText(_translate("MainWindow", str(res.q)))

                item = QtWidgets.QTableWidgetItem()
                self.tableWidget_56.setItem(count, 5, item)
                item = self.tableWidget_56.item(count, 5)
                item.setText(_translate("MainWindow", str(res.ts)))

                item = QtWidgets.QTableWidgetItem()
                self.tableWidget_56.setItem(count, 7, item)
                item = self.tableWidget_56.item(count, 7)
                item.setText(_translate("MainWindow", str(res.load_percentage)))

                item = QtWidgets.QTableWidgetItem()
                self.tableWidget_56.setItem(count, 8, item)
                item = self.tableWidget_56.item(count, 8)
                item.setText(_translate("MainWindow", str(res.system_load_percentage)))
                ...
                if self.pump_cop_status:
                    ...
                    item = self.tableWidget_56.item(count, 9)
                    item.setText(_translate("MainWindow", str(pump_cop)))

                if self.system_cop_status:
                    item = QtWidgets.QTableWidgetItem()
                    self.tableWidget_56.setItem(count, 10, item)
                    item = self.tableWidget_56.item(count, 10)
                    item.setText(_translate("MainWindow", str(res.cop)))

        self.pushButton_561.clicked.connect(show_cop)
        ...
        def clean_cop():
            for i in range(self.table_56_count):
                for k in range(16):
                    item = QtWidgets.QTableWidgetItem()
                    self.tableWidget_56.setItem(i+1, k, item)
                    item = self.tableWidget_56.item(i+1, k)
                    item.setText(_translate("MainWindow", ""))
        self.pushButton_565.clicked.connect(clean_cop)
